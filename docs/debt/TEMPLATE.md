...
<Origin: an ADR tradeoff that accepted it, expedience to ship, evolved circumstance, vendor constraint. Cite the ADR or PR if there is one. If there is no clear origin, write "drift" and explain how the workspace ended up here.>
...
- <ADR that accepted this debt, if any.>
