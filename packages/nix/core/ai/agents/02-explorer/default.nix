{ lib, ... }:
{
  config.core.ai.agents.explorer = {
    ...
    role = "Explorer";
    lane = "Exploration";
    description = "The Explorer agent maps this codebase: it locates files and symbols, traces call paths and data flow, and answers 'where/how does X work' within the repo. Read-only: it never edits.";
    capabilities = [
